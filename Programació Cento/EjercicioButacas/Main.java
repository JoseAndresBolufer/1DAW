            ...
            while (!salir) {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        int filaCompra = leerEntero(scanner);
                        System.out.print("Ingrese butaca: ");
                        int columnaCompra = leerEntero(scanner);
                        estadio.comprarEntrada(filaCompra, columnaCompra);
                        break;
                    case 2:
                        System.out.print("Ingrese fila: ");
                        int filaVenta = leerEntero(scanner);
                        System.out.print("Ingrese butaca: ");
                        int columnaVenta = leerEntero(scanner);
